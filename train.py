...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='models/yolov7.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='yolov7-tiny-person', help='save to project/name')
